                                      ...
                                      4 ; This file was generated Mon Sep  5 12:32:27 2022
                                      5 ;--------------------------------------------------------
                                      6 	.module sequence
      ...
      000003 02 00 62         [24]  709 	ljmp	_main
                           ...
                           000000   719 	C$sequence.c$3$0$0 ==.
                                    720 ;	sequence.c:3: void main(void)
                                    721 ;	-----------------------------------------
                                    722 ;	 function main
                                    723 ;	-----------------------------------------
      000062                        724 _main:
                           ...
                           000001   731 	ar1 = 0x01
                           000000   732 	ar0 = 0x00
                           000000   733 	C$sequence.c$5$1$2 ==.
                                    734 ;	sequence.c:5: while(1)
      000062                        735 00102$:
                           000000   736 	C$sequence.c$7$2$3 ==.
                                    737 ;	sequence.c:7: P1 = 0x10;
      000062 75 90 10         [24]  738 	mov	_P1,#0x10
                           000003   739 	C$sequence.c$8$2$3 ==.
                                    740 ;	sequence.c:8: delay();
      000065 12 00 7D         [24]  741 	lcall	_delay
                           000006   742 	C$sequence.c$9$2$3 ==.
                                    743 ;	sequence.c:9: P1 = 0x20;
      000068 75 90 20         [24]  744 	mov	_P1,#0x20
                           000009   745 	C$sequence.c$10$2$3 ==.
                                    746 ;	sequence.c:10: delay();
      00006B 12 00 7D         [24]  747 	lcall	_delay
                           00000C   748 	C$sequence.c$11$2$3 ==.
                                    749 ;	sequence.c:11: P1 = 0x40;
      00006E 75 90 40         [24]  750 	mov	_P1,#0x40
                           00000F   751 	C$sequence.c$12$2$3 ==.
                                    752 ;	sequence.c:12: delay();
      000071 12 00 7D         [24]  753 	lcall	_delay
                           000012   754 	C$sequence.c$13$2$3 ==.
                                    755 ;	sequence.c:13: P1 = 0x80;
      000074 75 90 80         [24]  756 	mov	_P1,#0x80
                           000015   757 	C$sequence.c$14$2$3 ==.
                                    758 ;	sequence.c:14: delay();
      000077 12 00 7D         [24]  759 	lcall	_delay
      00007A 80 E6            [24]  760 	sjmp	00102$
                           00001A   761 	C$sequence.c$17$1$2 ==.
      ...
      00007C 22               [24]  763 	ret
                           ...
                           00001B   771 	C$sequence.c$19$1$2 ==.
                                    772 ;	sequence.c:19: void delay(void)
                                    773 ;	-----------------------------------------
                                    774 ;	 function delay
                                    775 ;	-----------------------------------------
      00007D                        776 _delay:
                           00001B   777 	C$sequence.c$22$1$5 ==.
                                    778 ;	sequence.c:22: for(i=0;i<0xff;i++)
      00007D 7E 00            [12]  779 	mov	r6,#0x00
      00007F 7F 00            [12]  780 	mov	r7,#0x00
      000081                        781 00106$:
                           00001F   782 	C$sequence.c$23$1$5 ==.
                                    783 ;	sequence.c:23: for(j=0;j<0xff;j++);
      ...
      000093 70 F0            [24]  797 	jnz	00105$
                           000033   798 	C$sequence.c$22$1$5 ==.
                                    799 ;	sequence.c:22: for(i=0;i<0xff;i++)
      ...
      0000A3 40 DC            [24]  810 	jc	00106$
                           000043   811 	C$sequence.c$24$1$5 ==.
