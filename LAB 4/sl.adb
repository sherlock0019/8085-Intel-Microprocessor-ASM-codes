...
F:G$delayoff$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsl.delay$i$1$5({2}SI:S),R,0,0,[r6,r7]
S:Lsl.delay$j$1$5({2}SI:S),R,0,0,[r4,r5]
S:Lsl.delayoff$i$1$7({2}SI:S),R,0,0,[r6,r7]
S:Lsl.delayoff$j$1$7({2}SI:S),R,0,0,[r4,r5]
...
S:G$delay$2$3({2}DF,SI:S),C,0,0
S:G$delayoff$2$3({2}DF,SI:S),C,0,0
S:G$delay$0$0({2}DF,SV:S),C,0,0
S:G$delayoff$0$0({2}DF,SV:S),C,0,0
