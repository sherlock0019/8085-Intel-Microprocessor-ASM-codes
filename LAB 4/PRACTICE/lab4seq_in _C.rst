                                      ...
                                      4 ; This file was generated Mon Oct 31 11:11:48 2022
                                      5 ;--------------------------------------------------------
                                      6 	.module lab4seq_in__C
      ...
      000003 02 00 62         [24]  709 	ljmp	_main
                           ...
                           000000   719 	C$lab4seq_in__C.c$3$0$0 ==.
                                    720 ;	lab4seq_in _C.c:3: void main(void)
                                    721 ;	-----------------------------------------
                                    722 ;	 function main
                                    723 ;	-----------------------------------------
      000062                        724 _main:
                           ...
                           000001   731 	ar1 = 0x01
                           000000   732 	ar0 = 0x00
                           000000   733 	C$lab4seq_in__C.c$5$1$2 ==.
                                    734 ;	lab4seq_in _C.c:5: while(1)
      000062                        735 00102$:
                           000000   736 	C$lab4seq_in__C.c$7$2$3 ==.
                                    737 ;	lab4seq_in _C.c:7: P1 = 0x10;
      000062 75 90 10         [24]  738 	mov	_P1,#0x10
                           000003   739 	C$lab4seq_in__C.c$8$2$3 ==.
                                    740 ;	lab4seq_in _C.c:8: delay();
      000065 12 00 80         [24]  741 	lcall	_delay
                           000006   742 	C$lab4seq_in__C.c$9$2$3 ==.
                                    743 ;	lab4seq_in _C.c:9: P1 = 0x20;
      000068 75 90 20         [24]  744 	mov	_P1,#0x20
                           000009   745 	C$lab4seq_in__C.c$10$2$3 ==.
                                    746 ;	lab4seq_in _C.c:10: delay();
      00006B 12 00 80         [24]  747 	lcall	_delay
                           00000C   748 	C$lab4seq_in__C.c$11$2$3 ==.
                                    749 ;	lab4seq_in _C.c:11: P1 = 0x40;
      00006E 75 90 40         [24]  750 	mov	_P1,#0x40
                           00000F   751 	C$lab4seq_in__C.c$12$2$3 ==.
                                    752 ;	lab4seq_in _C.c:12: delay();
      000071 12 00 80         [24]  753 	lcall	_delay
                           000012   754 	C$lab4seq_in__C.c$13$2$3 ==.
                                    755 ;	lab4seq_in _C.c:13: P1 = 0x80;
      000074 75 90 80         [24]  756 	mov	_P1,#0x80
                           000015   757 	C$lab4seq_in__C.c$14$2$3 ==.
                                    758 ;	lab4seq_in _C.c:14: delay();
      000077 12 00 80         [24]  759 	lcall	_delay
                           000018   760 	C$lab4seq_in__C.c$15$2$3 ==.
                                    761 ;	lab4seq_in _C.c:15: delay();
      00007A 12 00 80         [24]  762 	lcall	_delay
      00007D 80 E3            [24]  763 	sjmp	00102$
                           00001D   764 	C$lab4seq_in__C.c$18$1$2 ==.
                           00001D   765 	XG$main$0$0 ==.
      00007F 22               [24]  766 	ret
                                    767 ;------------------------------------------------------------
                                    768 ;Allocation info for local variables in function 'delay'
                                    769 ;------------------------------------------------------------
                                    770 ;i                         Allocated to registers r6 r7 
                                    771 ;j                         Allocated to registers r4 r5 
                                    772 ;------------------------------------------------------------
                           00001E   773 	G$delay$0$0 ==.
                           00001E   774 	C$lab4seq_in__C.c$20$1$2 ==.
                                    775 ;	lab4seq_in _C.c:20: void delay(void)
                                    776 ;	-----------------------------------------
                                    777 ;	 function delay
                                    778 ;	-----------------------------------------
      000080                        779 _delay:
                           00001E   780 	C$lab4seq_in__C.c$23$1$5 ==.
                                    781 ;	lab4seq_in _C.c:23: for(i=0;i<0xff;i++)
      000080 7E 00            [12]  782 	mov	r6,#0x00
      000082 7F 00            [12]  783 	mov	r7,#0x00
      000084                        784 00106$:
                           000022   785 	C$lab4seq_in__C.c$24$1$5 ==.
                                    786 ;	lab4seq_in _C.c:24: for(j=0;j<0xff;j++);
      000084 7C FF            [12]  787 	mov	r4,#0xFF
      000086 7D 00            [12]  788 	mov	r5,#0x00
      000088                        789 00105$:
      000088 EC               [12]  790 	mov	a,r4
      000089 24 FF            [12]  791 	add	a,#0xFF
      00008B FA               [12]  792 	mov	r2,a
      00008C ED               [12]  793 	mov	a,r5
      00008D 34 FF            [12]  794 	addc	a,#0xFF
      00008F FB               [12]  795 	mov	r3,a
      000090 8A 04            [24]  796 	mov	ar4,r2
      000092 8B 05            [24]  797 	mov	ar5,r3
      000094 EA               [12]  798 	mov	a,r2
      000095 4B               [12]  799 	orl	a,r3
      000096 70 F0            [24]  800 	jnz	00105$
                           000036   801 	C$lab4seq_in__C.c$23$1$5 ==.
                                    802 ;	lab4seq_in _C.c:23: for(i=0;i<0xff;i++)
      000098 0E               [12]  803 	inc	r6
      000099 BE 00 01         [24]  804 	cjne	r6,#0x00,00120$
      00009C 0F               [12]  805 	inc	r7
      00009D                        806 00120$:
      00009D C3               [12]  807 	clr	c
      00009E EE               [12]  808 	mov	a,r6
      00009F 94 FF            [12]  809 	subb	a,#0xFF
      0000A1 EF               [12]  810 	mov	a,r7
      0000A2 64 80            [12]  811 	xrl	a,#0x80
      0000A4 94 80            [12]  812 	subb	a,#0x80
      0000A6 40 DC            [24]  813 	jc	00106$
                           000046   814 	C$lab4seq_in__C.c$25$1$5 ==.
                           000046   815 	XG$delay$0$0 ==.
      0000A8 22               [24]  816 	ret
                                    817 	.area CSEG    (CODE)
                                    818 	.area CONST   (CODE)
                                    819 	.area XINIT   (CODE)
