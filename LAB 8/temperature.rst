                                      ...
                                      4 ; This file was generated Mon Oct 17 13:37:05 2022
                                      5 ;--------------------------------------------------------
      ...
      000010                        671 _voltage::
      000010                        672 	.ds 4
                           00000C   673 Ltemperature.LCD_StringWrite$length$1$36==.
      ...
      00004B 02 02 3A         [24]  755 	ljmp	_it_SPI
                           ...
                           000000   769 	C$temperature.c$24$1$42 ==.
                                    770 ;	temperature.c:24: int adcVal=0, avgVal=0; //initVal=0;
      0000AA E4               [12]  771 	clr	a
      0000AB F5 08            [12]  772 	mov	_adcVal,a
      0000AD F5 09            [12]  773 	mov	(_adcVal + 1),a
                           000005   774 	C$temperature.c$24$1$42 ==.
                                    775 ;	temperature.c:24: unsigned char serial_data;
      0000AF F5 0A            [12]  776 	mov	_avgVal,a
      0000B1 F5 0B            [12]  777 	mov	(_avgVal + 1),a
                           000009   778 	C$temperature.c$28$1$42 ==.
                                    779 ;	temperature.c:28: unsigned char i=0;
                                    780 ;	1-genFromRTrack replaced	mov	_i,#0x00
      0000B3 F5 0F            [12]  781 	mov	_i,a
                           00000B   782 	C$temperature.c$21$1$42 ==.
                                    783 ;	temperature.c:21: __bit transmit_completed= 0;					// To check if spi data transmit is complete
      0000B5 C2 00            [12]  784 	clr	_transmit_completed
                           00000D   785 	C$temperature.c$22$1$42 ==.
                                    786 ;	temperature.c:22: __bit take_samples=0;
      ...
      00004E 02 00 BC         [24]  796 	ljmp	_main
                           ...
                           000000   806 	C$temperature.c$38$0$0 ==.
                                    807 ;	temperature.c:38: void main(void)
                                    808 ;	-----------------------------------------
                                    809 ;	 function main
                                    810 ;	-----------------------------------------
      0000BC                        811 _main:
                           ...
                           000001   818 	ar1 = 0x01
                           000000   819 	ar0 = 0x00
                           000000   820 	C$temperature.c$40$1$20 ==.
                                    821 ;	temperature.c:40: P2 = 0x00;								// Make Port 2 output .. for LCD data
      0000BC 75 A0 00         [24]  822 	mov	_P2,#0x00
                           000003   823 	C$temperature.c$41$1$20 ==.
                                    824 ;	temperature.c:41: P1 &= 0xEF;								// Make P1 Pin4 as output
      0000BF 53 90 EF         [24]  825 	anl	_P1,#0xEF
                           000006   826 	C$temperature.c$42$1$20 ==.
                                    827 ;	temperature.c:42: P0 &= 0xF8;								// Make Port 0 Pins 0,1,2 output
      0000C2 53 80 F8         [24]  828 	anl	_P0,#0xF8
                           000009   829 	C$temperature.c$44$1$20 ==.
                                    830 ;	temperature.c:44: SPI_Init();
      0000C5 12 02 63         [24]  831 	lcall	_SPI_Init
                           00000C   832 	C$temperature.c$45$1$20 ==.
                                    833 ;	temperature.c:45: LCD_Init();
      0000C8 12 02 94         [24]  834 	lcall	_LCD_Init
                           00000F   835 	C$temperature.c$46$1$20 ==.
                                    836 ;	temperature.c:46: Timer_Init();
      0000CB 12 02 81         [24]  837 	lcall	_Timer_Init
                           000012   838 	C$temperature.c$47$1$20 ==.
                                    839 ;	temperature.c:47: LCD_StringWrite("Temtur:  xxxx C", 15);
      ...
      0000D7 12 02 EB         [24]  843 	lcall	_LCD_StringWrite
                           00001E   844 	C$temperature.c$51$2$21 ==.
                                    845 ;	temperature.c:51: while(take_samples)                     //Take 10 samples at regular intervals using timer and 
      0000DA                        846 00111$:
      0000DA 30 01 FD         [24]  847 	jnb	_take_samples,00111$
                           000021   848 	C$temperature.c$55$3$22 ==.
                                    849 ;	temperature.c:55: for(i = 0; i < 10; i++)
      0000DD 75 0F 00         [24]  850 	mov	_i,#0x00
      0000E0 C2 01            [12]  851 	clr	_take_samples
      0000E2                        852 00117$:
                           000026   853 	C$temperature.c$57$4$23 ==.
                                    854 ;	temperature.c:57: CS_BAR = 0;                 // enable ADC as slave		 
      0000E2 C2 94            [12]  855 	clr	_P1_4
                           000028   856 	C$temperature.c$58$4$23 ==.
                                    857 ;	temperature.c:58: SPDAT= 0x01;		    // Write start bit to start ADC(Timing Diagram) 
      0000E4 75 C5 01         [24]  858 	mov	_SPDAT,#0x01
                           00002B   859 	C$temperature.c$59$4$23 ==.
                                    860 ;	temperature.c:59: while(!transmit_completed);	// wait end of transmition;
      0000E7                        861 00101$:
                           00002B   862 	C$temperature.c$60$4$23 ==.
                                    863 ;	temperature.c:60: transmit_completed = 0;    	// clear software transfert flag 
      0000E7 10 00 02         [24]  864 	jbc	_transmit_completed,00152$
      0000EA 80 FB            [24]  865 	sjmp	00101$
      0000EC                        866 00152$:
                           000030   867 	C$temperature.c$61$4$23 ==.
                                    868 ;	temperature.c:61: SPDAT= 0x80;			// 80H written to start ADC CH0 single ended sampling(refer D0D1D2config diag.)
      0000EC 75 C5 80         [24]  869 	mov	_SPDAT,#0x80
                           000033   870 	C$temperature.c$62$4$23 ==.
                                    871 ;	temperature.c:62: while(!transmit_completed);	// wait end of transmition 
      0000EF                        872 00104$:
      0000EF 30 00 FD         [24]  873 	jnb	_transmit_completed,00104$
                           000036   874 	C$temperature.c$63$4$23 ==.
                                    875 ;	temperature.c:63: data_save_high = serial_data & 0x03 ;  //
      0000F2 74 03            [12]  876 	mov	a,#0x03
      0000F4 55 0C            [12]  877 	anl	a,_serial_data
      0000F6 F5 0D            [12]  878 	mov	_data_save_high,a
                           00003C   879 	C$temperature.c$64$4$23 ==.
                                    880 ;	temperature.c:64: transmit_completed = 0;    	// clear software transfer flag 
      0000F8 C2 00            [12]  881 	clr	_transmit_completed
                           00003E   882 	C$temperature.c$66$4$23 ==.
                                    883 ;	temperature.c:66: SPDAT= 0x00;			// 
      0000FA 75 C5 00         [24]  884 	mov	_SPDAT,#0x00
                           000041   885 	C$temperature.c$67$4$23 ==.
                                    886 ;	temperature.c:67: while(!transmit_completed);	// wait end of transmition 
      0000FD                        887 00107$:
      0000FD 30 00 FD         [24]  888 	jnb	_transmit_completed,00107$
                           000044   889 	C$temperature.c$68$4$23 ==.
                                    890 ;	temperature.c:68: data_save_low = serial_data;
      000100 85 0C 0E         [24]  891 	mov	_data_save_low,_serial_data
                           000047   892 	C$temperature.c$69$4$23 ==.
                                    893 ;	temperature.c:69: transmit_completed = 0;    	// clear software transfer flag 
      000103 C2 00            [12]  894 	clr	_transmit_completed
                           000049   895 	C$temperature.c$70$4$23 ==.
                                    896 ;	temperature.c:70: CS_BAR = 1;                	// disable ADC as slave
      000105 D2 94            [12]  897 	setb	_P1_4
                           00004B   898 	C$temperature.c$72$4$23 ==.
                                    899 ;	temperature.c:72: adcVal = (data_save_high <<8) + (data_save_low);
      ...
      000115 F5 09            [12]  909 	mov	(_adcVal + 1),a
                           00005B   910 	C$temperature.c$73$4$23 ==.
                                    911 ;	temperature.c:73: avgVal += adcVal;		// accumulate the readings in avgVal
      ...
      000121 F5 0B            [12]  917 	mov	(_avgVal + 1),a
                           000067   918 	C$temperature.c$55$3$22 ==.
                                    919 ;	temperature.c:55: for(i = 0; i < 10; i++)
      000123 05 0F            [12]  920 	inc	_i
      000125 74 F6            [12]  921 	mov	a,#0x100 - 0x0A
      000127 25 0F            [12]  922 	add	a,_i
      000129 50 B7            [24]  923 	jnc	00117$
                           00006F   924 	C$temperature.c$76$1$20 ==.
                                    925 ;	temperature.c:76: avgVal = avgVal/100.0;			// the average reading
      ...
      000166 12 04 E0         [24]  956 	lcall	___fs2sint
                           0000AD   957 	C$temperature.c$77$1$20 ==.
                                    958 ;	temperature.c:77: avgVal = avgVal*(1024.0/3300.0); // in mV
      ...
      000184 90 E0 0A         [24]  971 	mov	dptr,#0xE00A
      000187 75 F0 9E         [24]  972 	mov	b,#0x9E
      00018A 74 3E            [12]  973 	mov	a,#0x3E
      ...
      0001A9 85 83 0B         [24]  988 	mov	(_avgVal + 1),dph
                           0000F0   989 	C$temperature.c$78$3$22 ==.
                                    990 ;	temperature.c:78: LCD_CmdWrite(0x89);		 //
      0001AC 75 82 89         [24]  991 	mov	dpl,#0x89
      0001AF 12 02 B3         [24]  992 	lcall	_LCD_CmdWrite
                           0000F6   993 	C$temperature.c$79$3$22 ==.
                                    994 ;	temperature.c:79: voltage[0] = avgVal%10 + 0x30; // add 0x30 to convert the corresponding number to ASCII
      ...
      0001C6 F5 10            [12] 1003 	mov	_voltage,a
                           00010C  1004 	C$temperature.c$80$1$20 ==.
                                   1005 ;	temperature.c:80: avgVal = avgVal/10;
      ...
      0001D4 12 06 A5         [24] 1010 	lcall	__divsint
                           00011B  1011 	C$temperature.c$81$3$22 ==.
                                   1012 ;	temperature.c:81: voltage[1] = avgVal%10 + 0x30;
      ...
      0001EB F5 11            [12] 1021 	mov	(_voltage + 0x0001),a
                           000131  1022 	C$temperature.c$82$1$20 ==.
                                   1023 ;	temperature.c:82: avgVal = avgVal/10;
      ...
      0001F9 12 06 A5         [24] 1028 	lcall	__divsint
                           000140  1029 	C$temperature.c$83$3$22 ==.
                                   1030 ;	temperature.c:83: voltage[3] = avgVal%10 + 0x30;
      ...
      000210 F5 13            [12] 1039 	mov	(_voltage + 0x0003),a
                           000156  1040 	C$temperature.c$84$1$20 ==.
                                   1041 ;	temperature.c:84: avgVal = avgVal/10;
      ...
      000224 85 83 0B         [24] 1048 	mov	(_avgVal + 1),dph
                           00016B  1049 	C$temperature.c$85$3$22 ==.
                                   1050 ;	temperature.c:85: voltage[2] = '.';
      000227 75 12 2E         [24] 1051 	mov	(_voltage + 0x0002),#0x2E
                           00016E  1052 	C$temperature.c$86$3$22 ==.
                                   1053 ;	temperature.c:86: LCD_StringWrite(voltage, 4);
      ...
      000236 02 00 DA         [24] 1058 	ljmp	00111$
                           00017D  1059 	C$temperature.c$90$1$20 ==.
      ...
      000239 22               [24] 1061 	ret
                           ...
                           00017E  1066 	C$temperature.c$97$1$20 ==.
                                   1067 ;	temperature.c:97: void it_SPI(void) __interrupt 9 /* interrupt address is 0x004B */
                                   1068 ;	-----------------------------------------
      ...
      00023E 75 D0 00         [24] 1074 	mov	psw,#0x00
                           000185  1075 	C$temperature.c$99$1$25 ==.
                                   1076 ;	temperature.c:99: switch	( SPSTA )         /* read and clear spi status register */
      ...
      00024D BF 80 05         [24] 1084 	cjne	r7,#0x80,00105$
                           000194  1085 	C$temperature.c$102$2$26 ==.
                                   1086 ;	temperature.c:102: serial_data=SPDAT;   /* read receive data */
      000250 85 C5 0C         [24] 1087 	mov	_serial_data,_SPDAT
                           000197  1088 	C$temperature.c$103$2$26 ==.
                                   1089 ;	temperature.c:103: transmit_completed=1;/* set software flag */
      000253 D2 00            [12] 1090 	setb	_transmit_completed
                           000199  1091 	C$temperature.c$113$1$25 ==.
                                   1092 ;	temperature.c:113: }
      000255                       1093 00105$:
      000255 D0 D0            [24] 1094 	pop	psw
      000257 D0 07            [24] 1095 	pop	ar7
                           00019D  1096 	C$temperature.c$114$1$25 ==.
      ...
      000259 32               [24] 1098 	reti
                           ...
                           00019E  1107 	C$temperature.c$116$1$25 ==.
                                   1108 ;	temperature.c:116: void timer0_ISR (void) __interrupt 1
                                   1109 ;	-----------------------------------------
                                   1110 ;	 function timer0_ISR
                                   1111 ;	-----------------------------------------
      00025A                       1112 _timer0_ISR:
                           00019E  1113 	C$temperature.c$118$1$28 ==.
                                   1114 ;	temperature.c:118: TH0 = 0x3C;	//For 25ms operation
      00025A 75 8C 3C         [24] 1115 	mov	_TH0,#0x3C
                           0001A1  1116 	C$temperature.c$119$1$28 ==.
                                   1117 ;	temperature.c:119: TL0 = 0xB0;
      00025D 75 8A B0         [24] 1118 	mov	_TL0,#0xB0
                           0001A4  1119 	C$temperature.c$120$1$28 ==.
                                   1120 ;	temperature.c:120: take_samples = 1;
      000260 D2 01            [12] 1121 	setb	_take_samples
                           0001A6  1122 	C$temperature.c$121$1$28 ==.
      ...
      000262 32               [24] 1124 	reti
                           ...
                           0001A7  1135 	C$temperature.c$130$1$28 ==.
                                   1136 ;	temperature.c:130: void SPI_Init()
                                   1137 ;	-----------------------------------------
                                   1138 ;	 function SPI_Init
                                   1139 ;	-----------------------------------------
      000263                       1140 _SPI_Init:
                           0001A7  1141 	C$temperature.c$132$1$29 ==.
                                   1142 ;	temperature.c:132: CS_BAR = 1;	                 // DISABLE ADC SLAVE SELECT-CS 
      000263 D2 94            [12] 1143 	setb	_P1_4
                           0001A9  1144 	C$temperature.c$133$1$29 ==.
                                   1145 ;	temperature.c:133: SPCON |= 0x20;               	 // P1.1(SSBAR) is available as standard I/O pin
      000265 43 C3 20         [24] 1146 	orl	_SPCON,#0x20
                           0001AC  1147 	C$temperature.c$134$1$29 ==.
                                   1148 ;	temperature.c:134: SPCON |= 0x01;                	// Fclk Periph/4 AND Fclk Periph=12MHz ,HENCE SCK IE. BAUD RATE=3000KHz 
      000268 43 C3 01         [24] 1149 	orl	_SPCON,#0x01
                           0001AF  1150 	C$temperature.c$135$1$29 ==.
                                   1151 ;	temperature.c:135: SPCON |= 0x10;               	 // Master mode ..configure SPI as master
      00026B 43 C3 10         [24] 1152 	orl	_SPCON,#0x10
                           0001B2  1153 	C$temperature.c$136$1$29 ==.
                                   1154 ;	temperature.c:136: SPCON &= ~0x08;               	// CPOL=0; transmit mode example|| SCK is 0 at idle state
      ...
      000273 F5 C3            [12] 1158 	mov	_SPCON,a
                           0001B9  1159 	C$temperature.c$137$1$29 ==.
                                   1160 ;	temperature.c:137: SPCON |= 0x04;                	// CPHA=1; transmit mode example 
      000275 43 C3 04         [24] 1161 	orl	_SPCON,#0x04
                           0001BC  1162 	C$temperature.c$138$1$29 ==.
                                   1163 ;	temperature.c:138: SPCON |= 0x40;                	// run spi;ENABLE SPI INTERFACE SPEN= 1 
      000278 43 C3 40         [24] 1164 	orl	_SPCON,#0x40
                           0001BF  1165 	C$temperature.c$139$1$29 ==.
                                   1166 ;	temperature.c:139: IEN1 |= 0x04;                	 // enable spi interrupt 
      00027B 43 B1 04         [24] 1167 	orl	_IEN1,#0x04
                           0001C2  1168 	C$temperature.c$140$1$29 ==.
                                   1169 ;	temperature.c:140: EA=1;                         	// enable interrupts
      00027E D2 AF            [12] 1170 	setb	_EA
                           0001C4  1171 	C$temperature.c$141$1$29 ==.
      ...
      000280 22               [24] 1173 	ret
                           ...
                           0001C5  1178 	C$temperature.c$148$1$29 ==.
                                   1179 ;	temperature.c:148: void Timer_Init()
                                   1180 ;	-----------------------------------------
                                   1181 ;	 function Timer_Init
                                   1182 ;	-----------------------------------------
      000281                       1183 _Timer_Init:
                           0001C5  1184 	C$temperature.c$155$1$30 ==.
                                   1185 ;	temperature.c:155: TH0 = 0x3C;			//For 25ms operation
      000281 75 8C 3C         [24] 1186 	mov	_TH0,#0x3C
                           0001C8  1187 	C$temperature.c$156$1$30 ==.
                                   1188 ;	temperature.c:156: TL0 = 0xB0;
      000284 75 8A B0         [24] 1189 	mov	_TL0,#0xB0
                           0001CB  1190 	C$temperature.c$157$1$30 ==.
                                   1191 ;	temperature.c:157: TMOD = (TMOD & 0xF0) | 0x01;  	// Set T/C0 Mode Timer 0 in Mode 1(as 16 bit T/C)
      ...
      00028D F5 89            [12] 1195 	mov	_TMOD,a
                           0001D3  1196 	C$temperature.c$158$1$30 ==.
                                   1197 ;	temperature.c:158: ET0 = 1;                      	// Enable Timer 0 Interrupts (in IEN0 register)
      00028F D2 A9            [12] 1198 	setb	_ET0
                           0001D5  1199 	C$temperature.c$159$1$30 ==.
                                   1200 ;	temperature.c:159: TR0 = 1;                      	// Start Timer 0 Running 
      000291 D2 8C            [12] 1201 	setb	_TR0
                           0001D7  1202 	C$temperature.c$160$1$30 ==.
      ...
      000293 22               [24] 1204 	ret
                           ...
                           0001D8  1209 	C$temperature.c$166$1$30 ==.
                                   1210 ;	temperature.c:166: void LCD_Init()
                                   1211 ;	-----------------------------------------
                                   1212 ;	 function LCD_Init
                                   1213 ;	-----------------------------------------
      000294                       1214 _LCD_Init:
                           0001D8  1215 	C$temperature.c$168$1$31 ==.
                                   1216 ;	temperature.c:168: sdelay(100);
      000294 90 00 64         [24] 1217 	mov	dptr,#0x0064
      000297 12 03 37         [24] 1218 	lcall	_sdelay
                           0001DE  1219 	C$temperature.c$169$1$31 ==.
                                   1220 ;	temperature.c:169: LCD_CmdWrite(0x38);   	        // LCD 2lines, 5*7 matrix
      00029A 75 82 38         [24] 1221 	mov	dpl,#0x38
      00029D 12 02 B3         [24] 1222 	lcall	_LCD_CmdWrite
                           0001E4  1223 	C$temperature.c$170$1$31 ==.
                                   1224 ;	temperature.c:170: LCD_CmdWrite(0x0E);			// Display ON cursor ON  Blinking off
      0002A0 75 82 0E         [24] 1225 	mov	dpl,#0x0E
      0002A3 12 02 B3         [24] 1226 	lcall	_LCD_CmdWrite
                           0001EA  1227 	C$temperature.c$171$1$31 ==.
                                   1228 ;	temperature.c:171: LCD_CmdWrite(0x01);			// Clear the LCD
      0002A6 75 82 01         [24] 1229 	mov	dpl,#0x01
      0002A9 12 02 B3         [24] 1230 	lcall	_LCD_CmdWrite
                           0001F0  1231 	C$temperature.c$172$1$31 ==.
                                   1232 ;	temperature.c:172: LCD_CmdWrite(0x80);			// Cursor to First line First Position
      0002AC 75 82 80         [24] 1233 	mov	dpl,#0x80
      0002AF 12 02 B3         [24] 1234 	lcall	_LCD_CmdWrite
                           0001F6  1235 	C$temperature.c$173$1$31 ==.
      ...
      0002B2 22               [24] 1237 	ret
                           ...
                           0001F7  1244 	C$temperature.c$180$1$31 ==.
                                   1245 ;	temperature.c:180: void LCD_CmdWrite(char cmd)
                                   1246 ;	-----------------------------------------
                                   1247 ;	 function LCD_CmdWrite
                                   1248 ;	-----------------------------------------
      0002B3                       1249 _LCD_CmdWrite:
      0002B3 AF 82            [24] 1250 	mov	r7,dpl
                           0001F9  1251 	C$temperature.c$182$1$33 ==.
                                   1252 ;	temperature.c:182: LCD_Ready();
      0002B5 C0 07            [24] 1253 	push	ar7
      0002B7 12 03 1A         [24] 1254 	lcall	_LCD_Ready
      0002BA D0 07            [24] 1255 	pop	ar7
                           000200  1256 	C$temperature.c$183$1$33 ==.
                                   1257 ;	temperature.c:183: LCD_data=cmd;     			// Send the command to LCD
      0002BC 8F A0            [24] 1258 	mov	_P2,r7
                           000202  1259 	C$temperature.c$184$1$33 ==.
                                   1260 ;	temperature.c:184: LCD_rs=0;         	 		// Select the Command Register by pulling LCD_rs LOW
      0002BE C2 80            [12] 1261 	clr	_P0_0
                           000204  1262 	C$temperature.c$185$1$33 ==.
                                   1263 ;	temperature.c:185: LCD_rw=0;          			// Select the Write Operation  by pulling RW LOW
      0002C0 C2 81            [12] 1264 	clr	_P0_1
                           000206  1265 	C$temperature.c$186$1$33 ==.
                                   1266 ;	temperature.c:186: LCD_en=1;          			// Send a High-to-Low Pusle at Enable Pin
      0002C2 D2 82            [12] 1267 	setb	_P0_2
                           000208  1268 	C$temperature.c$187$1$33 ==.
                                   1269 ;	temperature.c:187: sdelay(5);
      0002C4 90 00 05         [24] 1270 	mov	dptr,#0x0005
      0002C7 12 03 37         [24] 1271 	lcall	_sdelay
                           00020E  1272 	C$temperature.c$188$1$33 ==.
                                   1273 ;	temperature.c:188: LCD_en=0;
      0002CA C2 82            [12] 1274 	clr	_P0_2
                           000210  1275 	C$temperature.c$189$1$33 ==.
                                   1276 ;	temperature.c:189: sdelay(5);
      0002CC 90 00 05         [24] 1277 	mov	dptr,#0x0005
      0002CF 12 03 37         [24] 1278 	lcall	_sdelay
                           000216  1279 	C$temperature.c$190$1$33 ==.
      ...
      0002D2 22               [24] 1281 	ret
                           ...
                           000217  1288 	C$temperature.c$197$1$33 ==.
                                   1289 ;	temperature.c:197: void LCD_DataWrite( char dat)
                                   1290 ;	-----------------------------------------
                                   1291 ;	 function LCD_DataWrite
                                   1292 ;	-----------------------------------------
      0002D3                       1293 _LCD_DataWrite:
      0002D3 85 82 A0         [24] 1294 	mov	_P2,dpl
                           00021A  1295 	C$temperature.c$200$1$35 ==.
                                   1296 ;	temperature.c:200: LCD_rs=1;	   			// Select the Data Register by pulling LCD_rs HIGH
      0002D6 D2 80            [12] 1297 	setb	_P0_0
                           00021C  1298 	C$temperature.c$201$1$35 ==.
                                   1299 ;	temperature.c:201: LCD_rw=0;    	     			// Select the Write Operation by pulling RW LOW
      0002D8 C2 81            [12] 1300 	clr	_P0_1
                           00021E  1301 	C$temperature.c$202$1$35 ==.
                                   1302 ;	temperature.c:202: LCD_en=1;	   			// Send a High-to-Low Pusle at Enable Pin
      0002DA D2 82            [12] 1303 	setb	_P0_2
                           000220  1304 	C$temperature.c$203$1$35 ==.
                                   1305 ;	temperature.c:203: sdelay(5);
      0002DC 90 00 05         [24] 1306 	mov	dptr,#0x0005
      0002DF 12 03 37         [24] 1307 	lcall	_sdelay
                           000226  1308 	C$temperature.c$204$1$35 ==.
                                   1309 ;	temperature.c:204: LCD_en=0;
      0002E2 C2 82            [12] 1310 	clr	_P0_2
                           000228  1311 	C$temperature.c$205$1$35 ==.
                                   1312 ;	temperature.c:205: sdelay(5);
      0002E4 90 00 05         [24] 1313 	mov	dptr,#0x0005
      0002E7 12 03 37         [24] 1314 	lcall	_sdelay
                           00022E  1315 	C$temperature.c$206$1$35 ==.
      ...
      0002EA 22               [24] 1317 	ret
                           ...
                           00022F  1325 	C$temperature.c$212$1$35 ==.
                                   1326 ;	temperature.c:212: void LCD_StringWrite( char * str, unsigned char length)
                                   1327 ;	-----------------------------------------
      ...
      0002EF AF F0            [24] 1333 	mov	r7,b
                           000235  1334 	C$temperature.c$214$1$37 ==.
                                   1335 ;	temperature.c:214: while(length>0)
      0002F1                       1336 00101$:
      0002F1 E5 14            [12] 1337 	mov	a,_LCD_StringWrite_PARM_2
      0002F3 60 24            [24] 1338 	jz	00104$
                           000239  1339 	C$temperature.c$216$2$38 ==.
                                   1340 ;	temperature.c:216: LCD_DataWrite(*str);
      ...
      000313 D0 07            [24] 1356 	pop	ar7
                           000259  1357 	C$temperature.c$217$2$38 ==.
                                   1358 ;	temperature.c:217: str++;
                           000259  1359 	C$temperature.c$218$2$38 ==.
                                   1360 ;	temperature.c:218: length--;
      000315 15 14            [12] 1361 	dec	_LCD_StringWrite_PARM_2
      000317 80 D8            [24] 1362 	sjmp	00101$
      000319                       1363 00104$:
                           00025D  1364 	C$temperature.c$220$1$37 ==.
      ...
      000319 22               [24] 1366 	ret
                           ...
                           00025E  1371 	C$temperature.c$227$1$37 ==.
                                   1372 ;	temperature.c:227: void LCD_Ready() //*****************del
                                   1373 ;	-----------------------------------------
                                   1374 ;	 function LCD_Ready
                                   1375 ;	-----------------------------------------
      00031A                       1376 _LCD_Ready:
                           00025E  1377 	C$temperature.c$229$1$39 ==.
                                   1378 ;	temperature.c:229: LCD_data = 0xFF;
      00031A 75 A0 FF         [24] 1379 	mov	_P2,#0xFF
                           000261  1380 	C$temperature.c$230$1$39 ==.
                                   1381 ;	temperature.c:230: LCD_rs = 0;
      00031D C2 80            [12] 1382 	clr	_P0_0
                           000263  1383 	C$temperature.c$231$1$39 ==.
                                   1384 ;	temperature.c:231: LCD_rw = 1;
      00031F D2 81            [12] 1385 	setb	_P0_1
                           000265  1386 	C$temperature.c$232$1$39 ==.
                                   1387 ;	temperature.c:232: LCD_en = 0;
      000321 C2 82            [12] 1388 	clr	_P0_2
                           000267  1389 	C$temperature.c$233$1$39 ==.
                                   1390 ;	temperature.c:233: sdelay(5);
      000323 90 00 05         [24] 1391 	mov	dptr,#0x0005
      000326 12 03 37         [24] 1392 	lcall	_sdelay
                           00026D  1393 	C$temperature.c$234$1$39 ==.
                                   1394 ;	temperature.c:234: LCD_en = 1;
      000329 D2 82            [12] 1395 	setb	_P0_2
                           00026F  1396 	C$temperature.c$235$1$39 ==.
                                   1397 ;	temperature.c:235: while(LCD_busy == 1)
      00032B                       1398 00101$:
      00032B 30 A7 06         [24] 1399 	jnb	_P2_7,00103$
                           000272  1400 	C$temperature.c$237$2$40 ==.
                                   1401 ;	temperature.c:237: LCD_en = 0;
      00032E C2 82            [12] 1402 	clr	_P0_2
                           000274  1403 	C$temperature.c$238$2$40 ==.
                                   1404 ;	temperature.c:238: LCD_en = 1;
      000330 D2 82            [12] 1405 	setb	_P0_2
      000332 80 F7            [24] 1406 	sjmp	00101$
      000334                       1407 00103$:
                           000278  1408 	C$temperature.c$240$1$39 ==.
                                   1409 ;	temperature.c:240: LCD_en = 0;
      000334 C2 82            [12] 1410 	clr	_P0_2
                           00027A  1411 	C$temperature.c$241$1$39 ==.
      ...
      000336 22               [24] 1413 	ret
                           ...
                           00027B  1421 	C$temperature.c$248$1$39 ==.
                                   1422 ;	temperature.c:248: void sdelay(int delay)
                                   1423 ;	-----------------------------------------
      ...
      000339 AF 83            [24] 1428 	mov	r7,dph
                           00027F  1429 	C$temperature.c$251$1$42 ==.
                                   1430 ;	temperature.c:251: while(delay>0)
      00033B                       1431 00102$:
      ...
      000347 50 0F            [24] 1439 	jnc	00108$
                           00028D  1440 	C$temperature.c$253$2$43 ==.
                                   1441 ;	temperature.c:253: for(d=0;d<5;d++);
      ...
      00034F 70 FA            [24] 1448 	jnz	00107$
                           000295  1449 	C$temperature.c$254$2$43 ==.
                                   1450 ;	temperature.c:254: delay--;
      ...
      000358                       1456 00108$:
                           00029C  1457 	C$temperature.c$256$1$42 ==.
                           00029C  1458 	XG$sdelay$0$0 ==.
      000358 22               [24] 1459 	ret
                                   1460 	.area CSEG    (CODE)
                                   1461 	.area CONST   (CODE)
                           000000  1462 Ftemperature$__str_0$0$0 == .
      000791                       1463 ___str_0:
      000791 54 65 6D 74 75 72 3A  1464 	.ascii "Temtur:  xxxx C"
