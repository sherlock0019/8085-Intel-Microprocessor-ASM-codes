...
F:G$LCD_DataInt$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LCD_STRING$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$sdelay$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldisplay_string_2.LCD_CmdWrite$cmd$1$10({1}SC:U),R,0,0,[]
S:Ldisplay_string_2.LCD_DataWrite$dat$1$12({1}SC:U),R,0,0,[]
S:Ldisplay_string_2.LCD_DataInt$dat$1$14({2}SI:U),R,0,0,[r6,r7]
S:Ldisplay_string_2.LCD_STRING$data$1$16({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Ldisplay_string_2.LCD_STRING$i$1$17({2}SI:S),R,0,0,[r3,r4]
S:Ldisplay_string_2.sdelay$delay$1$20({2}SI:U),R,0,0,[r6,r7]
S:Ldisplay_string_2.sdelay$d$1$21({1}SC:S),R,0,0,[r5]
...
S:Fdisplay_string_2$__str_0$0$0({4}DA4d,SC:S),D,0,0
S:Fdisplay_string_2$__str_1$0$0({10}DA10d,SC:S),D,0,0
