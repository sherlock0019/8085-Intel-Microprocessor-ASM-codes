...
S:LLAB_7_C.sdelay$delay$1$7({2}SI:U),R,0,0,[r6,r7]
S:LLAB_7_C.sdelay$d$1$8({1}SC:S),R,0,0,[r5]
S:LLAB_7_C.lcd_cmdwrite$cmd$1$11({1}SC:U),R,0,0,[]
S:LLAB_7_C.lcd_datawrite$dat$1$13({1}SC:U),R,0,0,[]
